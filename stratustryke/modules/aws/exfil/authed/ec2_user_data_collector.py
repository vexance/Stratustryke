...
class Module(AWSModule):
    def __init__(self, framework) -> None:
        ...
        self._options.add_boolean('VERBOSE', 'When enabled, prints identified instance tags and IAM associations to the console', True, True)
        self._options.add_boolean('NO_DOWNLOAD', 'When enabled, disables source code download and only enumerates configs', True, False)
        self._options.add_boolean('ONLY_RUNNING', 'When enabled, limits output to only those EC2s currently running', True, False)
    ...
    def describe_instances(self, instance_id: str = None) -> list:
        ...
        only_running = self.get_opt('ONLY_RUNNING')
    ...
    def run(self) -> None:
        ...
        for instance in instances:
            ...
            if content != None:
                ...
                try:
                    download_path = str(Path(self.get_opt('DOWNLOAD_DIR')).resolve().absolute())
